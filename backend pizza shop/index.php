...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>P</span>Pizza</a>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            ...
            <div class="content">
               <h3>homemade Pepperoni Pizza With Olives</h3>
         ...
         <div class="slide">
            ...
            <div class="content">
               <h3>Pizza With Capsicum And Onion</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
         ...
         <div class="slide">
            ...
            <div class="content">
               <h3>Pizza With Mushrooms, Olives And SweetCorn</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>ayush@gmail.com</p>
         <p>ayushbhai@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Mr. Ayush Rawat </span> | all rights reserved!
   </div>
